window.addEventListener('load', () => {
    ...
    form.addEventListener('submit', (e) => {
        ...
        //numbering tasks part
        const task_no_el=document.createElement('input');
        task_no_el.classList.add('text');
        task_no_el.type = 'text';
        task_no_el.style.width ='10%';
        task_no_el.type='text';
        task_no_el.value=task_count.toString();
        task_no_el.setAttribute("readonly","readonly");
        task_content_el.appendChild(task_no_el);


//end of the numbering part
        ...
        alert("Please enter a task.It cannot be left blank.");
    }
    });
});
